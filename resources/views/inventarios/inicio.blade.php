            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5">
                        <a href="{{ route('inventarios.iniciopedidos') }}" class="card-link">
                    ...
                    @can('producto.crear')
                        <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5">
                            <a href="{{ route('inventarios.inicioproductos') }}" class="card-link">
                                <div class="icon-box service-box" data-aos="fade-up"
                                    data-aos-delay="{{ $delay = ($delay % $max) + $espacio }}">
                                    <div class="icon">
                        ...
                        <div class="w-4 col-md-6 col-lg-3 d-flex align-items-stretch mb-5">
                            <a href="{{ route('almacenes.index') }}" class="card-link">
                                <div class="icon-box service-box" data-aos="fade-up"
                                    ...
                                    <h4 class="title">Almacenes</h4>
                                    <p class="description">Habilita o deshabilita almacenes.</p>
                                </div>
                            </a>
                        </div>
                    @endcan
