<x-app-layout>
    ...
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Autorizar pedidos especiales') }}
        </h2>
    </x-slot>
    ...
    <div class="py-10">
        ...
        <div class="mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg px-5" style="width:100%;">
                ...
                <table id="data-table" class="stripe hover translate-table" style="width:94%; padding-top: 1em;  padding-bottom: 1em;">
                    ...
                    <tbody>
                        ...
                        <tr data-id="{{ $pedido->id }}">
                            <?php
                            $user = App\Models\Datosuser::whereeid($pedido->solicitante)->first();
                            if ($user != null) {
                            ...
                            <td class="px-14 py-1">
                                @if ( $pedido->foto != null)
                                <img src="{{ asset('pedidoespecial/' . $pedido->foto) }} " width="100ppx" id="imagenSeleccionada" alt="Foto actual del producto">
                                @else
                                <img src="{{ asset('imagen_productos/iconProduct.png') }} " width="50ppx" id="imagenSeleccionada" alt="Foto actual del producto">
                                @endif
                            </td>
                            <?php
                            switch ($pedido->import) {
                                case '1':
                                    $prioridad = "Baja";
                                    break;
                                case '2':
                            ...
                            <td class=" px-4 py-2">
                                <div class=" justify-center rounded-lg text-lg" role="group">
                                    <!-- botón Ver -->
                                    <a href="{{ route('inventarios.authPedidoEspecial', $pedido) }}" style="text-decoration: none" class="rounded bg-yellow-400 hover:bg-yellow-500 text-white font-bold py-2 px-4 mx-auto mr-2">Ver</a>
                                </div>
                            </td>
