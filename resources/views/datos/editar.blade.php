            ...
            @csrf --}}
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-8 mt-5 mx-7">
                    ...
                    <div class="grid grid-cols-1">
                        ...
                        <input name="eid" value="{{$datos->eid}}" class=" @error('eid') is-invalid @enderror py-2 px-3 rounded-lg border-2 border-blue-600 mt-1 focus:outline-none focus:ring-2 focus:ring-blue-700 focus:border-transparent" type="text" value="{{old('eid')}}" required/>
                        @error('eid')
                    ...
                    <div class="grid grid-cols-1">
                        ...
                        <input name="nombre" value="{{$datos->nombre}}" maxlength="191" class="py-2 px-3 rounded-lg border-2 border-blue-600 mt-1 focus:outline-none focus:ring-2 focus:ring-blue-700 focus:border-transparent" type="text" value="{{old('nombre')}}" required/>
                    </div>
                    <div class="grid grid-cols-1">
                        <label class="uppercase md:text-sm text-xs text-gray-500 text-light font-semibold">Apellido Paterno:</label>
                        <input name="paterno" value="{{$datos->paterno}}" maxlength="191" class="py-2 px-3 rounded-lg border-2 border-blue-600 mt-1 focus:outline-none focus:ring-2 focus:ring-blue-700 focus:border-transparent" type="text" value="{{old('paterno')}}" required/>
                    </div> 
                    <div class="grid grid-cols-1">
                        <label class="uppercase md:text-sm text-xs text-gray-500 text-light font-semibold">Apellido Materno:</label>
                        <input name="materno" value="{{$datos->materno}}" maxlength="191" class="py-2 px-3 rounded-lg border-2 border-blue-600 mt-1 focus:outline-none focus:ring-2 focus:ring-blue-700 focus:border-transparent" type="text" value="{{old('materno')}}" required/>
                    </div> 
                    <div class="grid grid-cols-1">
                        <label class="uppercase md:text-sm text-xs text-gray-500 text-light font-semibold">Fecha de Ingreso:</label>
                        <input name="ingreso" value="{{$datos->ingreso}}" min="1900-01-01" max="{{date('Y-m-d');}}" type="date" class="py-2 px-3 rounded-lg border-2 border-blue-600 mt-1 focus:outline-none focus:ring-2 focus:ring-blue-700 focus:border-transparent" type="text" value="{{old('ingreso')}}" required/>
                    </div> 
                    <div class="grid grid-cols-1">
