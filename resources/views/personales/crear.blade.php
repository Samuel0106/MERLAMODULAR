    ...
    <div class="py-12">
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                ...
                <form action="{{ route('personales.store', $eid) }}" method="POST" enctype="multipart/form-data" class="formEnviar">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-8 mt-5 mx-7 py-4">
                    <div class="grid grid-cols-1">
                        ...
                        <input readonly name="eid" class=" @error('eid') is-invalid @enderror py-2 px-3 rounded-lg border-2 border-blue-600 mt-1 focus:outline-none focus:ring-2 focus:ring-blue-700 focus:border-transparent" type="text" value="{{$eid}}" required/>
                        @error('eid')
                ...
                <div class="grid grid-cols-3 gap-5 md:gap-8 mt-5 mx-7">   
                    ...
                    <div class="grid grid-cols-1">
                        ...
                        <input name="vacuna" type="number" min="0" max="99" class="py-2 px-3 rounded-lg border-2 border-blue-600 mt-1 focus:outline-none focus:ring-2 focus:ring-blue-700 focus:border-transparent" required/>
                    </div>
                    <div class="grid grid-cols-1">
                        <label class="uppercase md:text-sm text-xs text-gray-500 text-light font-semibold">Fecha de la ultima vacuna:</label>
                        <input name="fecha" type="date" min="1900-01-01" max="{{date('Y-m-d');}}" class="py-2 px-3 rounded-lg border-2 border-blue-600 mt-1 focus:outline-none focus:ring-2 focus:ring-blue-700 focus:border-transparent" required/>
                    </div>
                    <div class="grid grid-cols-1">
                        <label class="uppercase md:text-sm text-xs text-gray-500 text-light font-semibold">Inmunizaciones:</label>
                        <input name="inmunizaciones" type="number" min="0" max="99" class="py-2 px-3 rounded-lg border-2 border-blue-600 mt-1 focus:outline-none focus:ring-2 focus:ring-blue-700 focus:border-transparent" required/>
                    </div>
                </div>
                <div class="grid grid-cols-2 gap-5 md:gap-8 mt-5 mx-7">   
                    <div class="grid grid-cols-1">
                        ...
                        <textarea name="cirugia" rows="2" style="resize:none" maxlength="191" class=" py-2 px-3 rounded-lg border-2 border-blue-600 mt-1 focus:outline-none focus:ring-2 focus:ring-blue-700 focus:border-transparent " type="text" required/> </textarea>
                    </div>
        
                    <div class="grid grid-cols-1">
                        <label class="uppercase md:text-sm text-xs text-gray-500 text-light font-semibold">Herencia:</label>
                        <textarea name="herencia" rows="2" style="resize:none" maxlength="191" class=" py-2 px-3 rounded-lg border-2 border-blue-600 mt-1 focus:outline-none focus:ring-2 focus:ring-blue-700 focus:border-transparent " type="text" required/> </textarea>
                    </div>
                </div>
                <div class="grid grid-cols-4 gap-5 md:gap-8 mt-5 mx-7">
                    <div class="grid grid-cols-1">
                        ...
                        <select name="tabaquismo" class=" py-2 px-3 rounded-lg border-2 border-blue-600 mt-1 focus:outline-none focus:ring-2 focus:ring-blue-700 focus:border-transparent" type="text" required/>
                    ...
                    <div class="grid grid-cols-1">
                        ...
                        <select name="alcholismo" class=" py-2 px-3 rounded-lg border-2 border-blue-600 mt-1 focus:outline-none focus:ring-2 focus:ring-blue-700 focus:border-transparent" type="text" required/>
                            <option value="Si">Si</option>
                            <option value="No" selected="No">No</option>
                        </select>
                    </div>
                    <div class="grid grid-cols-1">
                        ...
                        <select name="toxicomanias" class=" py-2 px-3 rounded-lg border-2 border-blue-600 mt-1 focus:outline-none focus:ring-2 focus:ring-blue-700 focus:border-transparent" type="text" required/>
                            <option value="Si">Si</option>
                            <option value="No" selected="No">No</option>
                        </select>
                    </div>
                    <div class="grid grid-cols-1">
                        ...
                        <input name="par_sexuales" type="text" maxlength="191" class=" py-2 px-3 rounded-lg border-2 border-blue-600 mt-1 focus:outline-none focus:ring-2 focus:ring-blue-700 focus:border-transparent" required/>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-5 gap-5 md:gap-8 mt-5 mx-7">
                    ...
                    <div class="grid grid-cols-1">
                        ...
                        <input name="fum" type="number" min="0" max="99" class="py-2 px-3 rounded-lg border-2 border-blue-600 mt-1 focus:outline-none focus:ring-2 focus:ring-blue-700 focus:border-transparent" required/>
                    </div>
                    <div class="grid grid-cols-1">
                        <label class="uppercase md:text-sm text-xs text-gray-500 text-light font-semibold">Menarca:</label>
                        <input name="menarca" type="text" maxlength="191" class="py-2 px-3 rounded-lg border-2 border-blue-600 mt-1 focus:outline-none focus:ring-2 focus:ring-blue-700 focus:border-transparent" required/>
                    </div>
                    
                    <div class="grid grid-cols-1">
                        <label class="uppercase md:text-sm text-xs text-gray-500 text-light font-semibold">Para:</label>
                        <input name="para" type="number" min="0" max="99" class="py-2 px-3 rounded-lg border-2 border-blue-600 mt-1 focus:outline-none focus:ring-2 focus:ring-blue-700 focus:border-transparent" required/>
                    </div>
                    <div class="grid grid-cols-1">
                        <label class="uppercase md:text-sm text-xs text-gray-500 text-light font-semibold">Aborto</label>
                        <input name="aborto" type="number" min="0" max="99" class="py-2 px-3 rounded-lg border-2 border-blue-600 mt-1 focus:outline-none focus:ring-2 focus:ring-blue-700 focus:border-transparent" required/>
                    </div>
                    <div class="grid grid-cols-1">
                        <label class="uppercase md:text-sm text-xs text-gray-500 text-light font-semibold">Cesarias</label>
                        <input name="cesaria" type="number" min="0" max="99" class=" py-2 px-3 rounded-lg border-2 border-blue-600 mt-1 focus:outline-none focus:ring-2 focus:ring-blue-700 focus:border-transparent" required/>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-2 gap-5 md:gap-8 mt-5 mx-7">
                    <div class="grid grid-cols-1">
                        ...
                        <textarea name="ets" style="resize:none" maxlength="191" class=" py-2 px-3 rounded-lg border-2 border-blue-600 mt-1 focus:outline-none focus:ring-2 focus:ring-blue-700 focus:border-transparent " type="text" required/> </textarea>
                    </div>
                    <div class="grid grid-cols-1">
                        <label class="uppercase md:text-sm text-xs text-gray-500 text-light font-semibold">anticonceptivos</label>
                        <textarea name="anticonceptivos" style="resize:none" maxlength="191" class=" py-2 px-3 rounded-lg border-2 border-blue-600 mt-1 focus:outline-none focus:ring-2 focus:ring-blue-700 focus:border-transparent " type="text" required/> </textarea>
                    </div>
                    <div class="grid grid-cols-1">
                        <label class="uppercase md:text-sm text-xs text-gray-500 text-light font-semibold">Pap</label>
                        <input name="pap" type="date" min="1900-01-01" max="2099-12-31" class=" py-2 px-3 rounded-lg border-2 border-blue-600 mt-1 focus:outline-none focus:ring-2 focus:ring-blue-700 focus:border-transparent" required/>
                    </div>
                </div>
                <div class='flex items-center justify-center  md:gap-8 gap-4 pt-5 pb-5 mt-5'>
                    <!-- botón cancelar -->
                    <a href="{{ route('personales.indice', $eid) }}" class='w-auto bg-gray-500 hover:bg-gray-700 rounded-lg shadow-xl font-medium text-white px-4 py-2'>Cancelar</a>
                    <!-- botón enviar -->
                    <form action="{{ route('personales.index') }}" method="POST" class="formEnviar w-auto bg-blue-500 hover:bg-gray-700 rounded-lg shadow-xl font-medium text-white px-4 py-2">
